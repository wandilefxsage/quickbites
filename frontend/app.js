...
async function fetchRestaurants() {
    ...
    try {
        ...
        data.forEach(restaurant => {
            // Setup fallback image or tag info
            const tags = restaurant.cuisine_type ? restaurant.cuisine_type.join(', ') : 'General Cuisine';
            ...
            if (restaurant.menu_items && restaurant.menu_items.length > 0) {
                menuHTML = `<div class="mt-4 pt-3 border-t border-gray-100">
                    <p class="text-xs font-bold text-gray-500 uppercase tracking-wider">Popular Items</p>
